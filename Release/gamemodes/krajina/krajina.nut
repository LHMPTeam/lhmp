...
local spawnpos = [[-7.19,0.26,-32.48],[10.72,0.138,22.740],[-8.232,3.86,-23.9825],[-27.54,0.2138,-83.08],[26.04,0.05,-59.109],[27.44,0.47,-10.18],[-23.39,0.31,-39.516]];
...
function  onServerInit()
{
	...
	serverSetDefaultMap("MISE09-PREJIMKA");
