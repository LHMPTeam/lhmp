...
//----------------------------------------------------------------------------- IMPORTANT STUFF
local rcon = "YOURPASSWORDx";	// DO NOT FORGET TO CHANGE THIS
local adInterval = 120;			// In what interval should server advertisement come.
local ads = ["This is example server!","Gamemode is created by author!","Visit www.site.com for additional info!"]; // Add here as much ads as you wish.
local varfreq = 40;				// Player shout frequency per cent. (0-100)
local shoutDelay = 3;			// Delay between another shout
//----------------------------------------------------------------------------- ARRAYS

//Dynamic
local admin = array(serverGetMaxPlayers(),0);
local radio = array(serverGetMaxPlayers(),0);
local shoutTS = array(serverGetMaxPlayers(),0);
//Static
...
local spawnpos = [[-28.8,1.483,52.47],[-14.1,1.46,46.23],[6.06,1.5,41],[10.9,1.41,30.1],[4.08,1.29,19.57],[4,1.29,19,57],[-23.8,1.20,14.1],[-2.9,1.28,19.27],[-7.55,1.39,34.037],[-23.437,1.39,36.37],[-31.5,4.8,30.7],[-31.3,11.24,31.563],[-33.42,1.37,36.04],[-39.28,1.4771,52.5077],[-9.947,1.379,32.42]];
local shoutsKill = ["00940001","01010080","01940012","01940017","01940069","01940074","01990141","01990361","01990421","01990831","01990861","02010040","02010110","02940010","02940014","0294022","02940028"];
local shoutsVar = ["01990831","02940001","02940025","01990811","01940016","01930069","01990131","01940069","01990841","01990831","01990211","01010080","01990211"];
...
function onPlayerShoot(ID,wepID){
	if((rand() % 100) < (varfreq) && ((time() - shoutTS[ID]) > shoutDelay)){
...
function onPlayerIsKilled(ID,killerID){
	if(ID!=killerID){
		...
		sendAllMessage("Player "+playerGetName(ID)+" commited suicide.");
	}
